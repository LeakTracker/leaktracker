...
class ReportsSubmittedScreen extends StatefulWidget {
  const ReportsSubmittedScreen({super.key});

  @override
  State<ReportsSubmittedScreen> createState() => _ReportsSubmittedScreenState();
}

class _ReportsSubmittedScreenState extends State<ReportsSubmittedScreen> {
  ...
  getUserInfo() {
    ...
    _reportsStream = FirebaseFirestore.instance
        ...
        .where(REPORT_STATUS, isEqualTo: STATUS_SUBMITTED)
