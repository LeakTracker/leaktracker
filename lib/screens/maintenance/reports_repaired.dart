...
class ReportsRepairedScreen extends StatefulWidget {
  const ReportsRepairedScreen({super.key});

  @override
  State<ReportsRepairedScreen> createState() => _ReportsRepairedScreenState();
}

class _ReportsRepairedScreenState extends State<ReportsRepairedScreen> {
  ...
  getUserInfo() {
    ...
    _reportsStream = FirebaseFirestore.instance
        ...
        .where(REPORT_STATUS, isEqualTo: STATUS_REPAIRED)
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "Total number of repaired reports.",
                    style: TextStyle(
                      fontSize: 18.0,
                      color: Colors.white,
                    ),
